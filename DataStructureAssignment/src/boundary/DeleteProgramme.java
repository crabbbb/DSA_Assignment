 ...
 * @author LOH XIN JIE
 */
public class DeleteProgramme extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("-- DELETE PROGRAMME --");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (Message.OKOptionMessage("Confirm to Delete this Programme ?")) {
            // confirm delete

            if (ttlGrpList != null && !ttlGrpList.isEmpty()) {
                ptgControl.deleteListOfTutorialGrp(ttlGrpList);
            }
            pControl.deleteProgramme(programme);

            // delete finish close this frame
            closeFrame();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteProgramme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteProgramme(new Programme("ROS")).setVisible(true);
            }
        });
    }
