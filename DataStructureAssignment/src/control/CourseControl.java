...
public class CourseControl {
    ...
    /**
     * add course if valid db add course id, name, description, creditHours
     * return message + id read n add
     */
    ...
    /**
     * under what situation will be repeating loop only can have 8 character
     * length check repeat cannot be empty or null value length BACS2063 = 8
     *
    ...
    /**
     * only in character format check repeat cannot be empty or null value
     */
    ...
    /**
     * only in numeric format only 1-4 accept cannot be empty or null value]
     *
     * @return
     */
    ...
    /**
     * check id related cannot be empty or null value return the search result
     *
     */
